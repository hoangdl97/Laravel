...
@section('management', 'Manager Project Status')

@section('content')
<div class="d-flex col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <a type="button" href="{{ route('projectstatus.create') }}" class="btn btn-success col-auto mr-auto">
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <br>
    <div class="d-flex">
        <form class="form-inline" method="get" action="{{ route('projectstatus.search') }}">
    ...
    <table class="table table-sm table-hover bg-light w-25">
        ...
        <tr>
            <td class="text-center">{{ $projectstatus->name }}</td>
            <td class="d-flex justify-content-center">
                <a type="button" href="{{ route ('projectstatus.edit', $projectstatus->id) }}" class="btn btn-info d-flex">
                    <span class="fa fa-edit mr-2 mt-1"></span>Edit
                </a>
                &nbsp;
                <form action="{{ route('projectstatus.destroy', $projectstatus->id) }}" method="POST" accept-charset="utf-">
                    @method('DELETE')
                    @csrf
    ...
    <div class="d-flex justify-content-end">
            {{ $project_statuses->appends($_GET)->links() }}
