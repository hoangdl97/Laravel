...
unset($__errorArgs, $__bag); ?>" name="image" value="<?php echo e(old('image')); ?>" required autocomplete="image">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="is_admin" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Position')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('is_admin')); ?>" required autocomplete="is_admin">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="passwordConfirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Confirm Password')); ?></label>

                            <div class="col-md-6">
                                <input id="passworConfirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/blog/resources/views/auth/register.blade.php ENDPATH**/ ?>