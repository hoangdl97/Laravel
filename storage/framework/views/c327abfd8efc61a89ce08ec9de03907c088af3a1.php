...
<div class="container">
    <div class="text-center">
        <h1><span class="fa fa-user-plus mr-2"></span>Add Customer</h1>
        <hr/>
    </div>
    <div class="row">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(route('customer.index')); ?>" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/blog/resources/views/customers/create.blade.php ENDPATH**/ ?>